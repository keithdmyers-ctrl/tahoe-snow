...
- `resorts`: Per-resort forecast data (Heavenly, Northstar, Kirkwood, Palisades Tahoe, Sugar Bowl)
...
- `storm`: Active storm tracking state (barometric detection)
- `hero_stats`: Key numbers for dashboard hero cards
- `summary`: One-line text summary
- `model_weights`: Current BMA model weights
- `air_quality`: Current AQI, PM2.5, PM10, ozone, 72h hourly forecast
- `radar`: Radar nowcast (precipitation approaching detection)
